package com.fbscorp.capstone.teleprompter.adapters;
...
import com.fbscorp.capstone.teleprompter.R;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.viewHolder> {
    ...
    public MainAdapter(ArrayList<Text> mTexts, OnClickListener mListener) {
        listener = mListener;
        texts = mTexts;
    }
